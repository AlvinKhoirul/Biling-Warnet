...
daftar db 13,10,'--------------------------------------------------------|'
       ...
       db 13,10,'+---+-------------------------+-------------------------+'
       db 13,10,'| 4 |  Paket begadang (VIP)   |  Rp 80.000/malam        |'
       db 13,10,'+---+-------------------------+-------------------------+'
...
teks3 db 13,10,'PAKET BEGADANG'
      db 13,10,'Anda telah memilih rental/sewa Paket Begadang selama 1 Malam, maka total yang harus anda bayar adalah Rp 60.000 '
      db 13,10,'Terima kasih sudah menjadi pelanggan di tempat kami $'
